...
# 04 · 사무실을 세 곳으로 — 맥미니 A + B + C에서 4마리 키우기
...
- [ ] 1마리 / 2마리 가이드 ([ep.3](./ep-03-single-agent), [ep.4](./ep-04-two-agents-same-host)) 끝낸 상태
...
> 📌 **같은 머신 안 협업이 궁금하면** → [ep.4 STEP 6 작동법](./ep-04-two-agents-same-host) 참조. 멘션·sessions_send·위임 spawn 3가지 방식이 거기.
...
여기까지가 5편 시리즈의 끝. 비교 → 개념 → 1마리 → 2마리 → N대 머신으로 확장하면서 셋업과 작동법을 한 호흡에 풀었어.
