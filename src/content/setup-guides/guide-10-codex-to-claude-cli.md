...
> 💡 처음부터 OpenClaw 셋업하시는 분이라면 → [ep-01 (왜 CLI로 왔나)](/multi-agent/ep-01-api-vs-cli)부터 보시는 게 맥락 잡기 좋아요.

---

## 왜 옮기는 거예요?

자세한 변천사는 [ep-01](/multi-agent/ep-01-api-vs-cli)에서 풀었어요. 여기선 짧게:
...
- 처음 셋업이라면 → [ep-02 1마리 출근시키기](/multi-agent/ep-02-single-agent)
- 변천사 맥락이 궁금하면 → [ep-01 우리가 Claude CLI로 온 이야기](/multi-agent/ep-01-api-vs-cli)
